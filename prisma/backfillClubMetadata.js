...
const CLUB_DEFAULTS_BY_NAME = {
    "Sci-Fi Readers": {
        genre: "Science Fiction",
        coverImage: "https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=900&q=80",
    },
    "Mystery & Thriller Club": {
        genre: "Mystery",
        coverImage: "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=900&q=80",
    },
    "Fantasy Fellowship": {
        genre: "Fantasy",
        coverImage: "https://images.unsplash.com/photo-1512820790803-83ca734da794?w=900&q=80",
    },
    "Non-Fiction Circle": {
        genre: "Non-Fiction",
        coverImage: "https://images.unsplash.com/photo-1455885666463-9c4b7fe58a8f?w=900&q=80",
    },
    ...
    "Self Help & Personal Growth": {
        ...
        coverImage: "https://images.unsplash.com/photo-1516979187457-637abb4f9353?w=900&q=80",
    },
    "Private Classics Club": {
        genre: "Classics",
        coverImage: "https://images.unsplash.com/photo-1506880018603-83d5b814b5a6?w=900&q=80",
    },
};
...
async function main() {
    ...
    for (let index = 0; index < clubsToBackfill.length; index += 1) {
        ...
        const nextGenre = club.genre ?? namedDefaults?.genre ?? inferGenre(club.name) ?? "General";
        const nextCoverImage = club.coverImage ??
